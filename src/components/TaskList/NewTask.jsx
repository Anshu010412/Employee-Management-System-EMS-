...
const NewTask = ({ data }) => {
    return (
        <div className='snap-start flex-shrink-0 min-w-[280px] w-[84vw] sm:w-[300px] bg-violet-400 rounded-2xl p-5 shadow-md'>
            ...
            <div className='flex flex-col sm:flex-row gap-3 mt-5'>
                <button className='flex-1 bg-green-600 py-3 text-sm rounded-lg text-white active:scale-[0.99]'>Accept Task</button>
                <button className='flex-1 bg-red-500 py-3 text-sm rounded-lg text-white active:scale-[0.99]'>Reject Task</button>
            </div>
        </div>
    )
}
