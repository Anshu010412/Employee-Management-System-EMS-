...
const CompleteTask = ({ data }) => {
    return (
        <div className='snap-start flex-shrink-0 min-w-[280px] w-[84vw] sm:w-[300px] bg-yellow-600 rounded-2xl p-5 shadow-md'>
            ...
            <div className='mt-5'>
                <button className='w-full bg-green-600 py-3 text-sm rounded-lg text-white active:scale-[0.99]'>Completed</button>
            </div>
        </div>
    )
}
